export default {
	...
	RESPONSE_MESSAGE: {
		...
		ADMINUSER: {
			...
			EMAILVERIFY: 'Email verification is  successfully',
		},
		CLIENTUSER: {
			CREATESUCCESS: 'Client user created successfully',
			CREATEFAILED: 'Client user creating failed',
			USERAVAILABLE: 'Client is available',
			FETCHSUCCESS: 'Client Fetch Successfully',
			FAILED: 'Client Failed',
			LOGINSUSSPEND: 'Client is susspending',
			NOTCLIENTUSER: 'Client user is not avalible',
		},
		DOCUMENT: {
			DOCUMENTSUCCESS: 'Document create successfully',
			DOCUMENTSUCCESSDELETE: 'Document delete successfully',
			DOCUMENTSUCCESSDELETEFAILED: 'Document delete failed successfully',
			DOCUMENTFAILED: 'Document creating failed',
			DOCUMENTAVAILABLE: 'Document is available',
			FETCHSUCCESS: 'Document Fetch Successfully',
			FAILED: 'Document Failed',
			NOTDOCUMENT: 'Document  is not avalible',
		},
		AUTHMIDDLEWARE: {
